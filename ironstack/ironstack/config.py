...
DEFAULT_CONFIG = {
    ...
    "waf": {
        "enabled": False,
        "engine": "coraza",          # coraza, modsecurity
        "port": 8080,
        "listen_address": "127.0.0.1",
        "rules_path": None,          # Path to custom rules
        "ruleset": "owasp-crs",      # owasp-crs, custom
...
class IronStackConfig:
    ...
    def _validate(self):
        ...
        if self.data["waf"]["enabled"]:
            valid_engines = ["coraza", "modsecurity"]
